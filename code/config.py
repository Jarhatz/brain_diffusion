...
class Config_Generative_Model:
    def __init__(self):
        ...
        self.eeg_signals_path = os.path.join(self.root_path, 'datasets/eeg_subset.pth')
        self.splits_path = os.path.join(self.root_path, 'datasets/block_splits_subset.pth')
        # self.splits_path = os.path.join(self.root_path, 'datasets/block_splits_by_image_all.pth')
        self.roi = 'VC'

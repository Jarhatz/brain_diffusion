...
# Experiments:
# Cosine Similarity:
# CUDA_VISIBLE_DEVICES=2,3 python3 code/eeg_ldm.py --dataset EEG --batch_size 10 --num_epoch 100 --lr 1e-5 > exps/sub_cos_100_1e-5.txt

# SimCLR:
# CUDA_VISIBLE_DEVICES=2,3 python3 code/eeg_ldm.py --dataset EEG --batch_size 10 --num_epoch 100 --lr 1e-3 > exps/sub_simclr_100_1e-3.txt

# SCL:
# CUDA_VISIBLE_DEVICES=2,3 python3 code/eeg_ldm.py --dataset EEG --batch_size 10 --num_epoch 100 --lr 1e-3 > exps/sub_scl_100_1e-3.txt
...
def generate_images(generative_model, eeg_latents_dataset_train, eeg_latents_dataset_test, config):
    ...
    for sp_idx, imgs in enumerate(samples):
        for copy_idx, img in enumerate(imgs[0:]): # [1:]
            img = rearrange(img, 'c h w -> h w c')
...
def main(config):
    ...
    # print('Loaded Pretrained eeg_encoder Checkpoint metafile...')

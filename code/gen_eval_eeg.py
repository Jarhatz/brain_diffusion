...
# CUDA_VISIBLE_DEVICES=0 python3 code/gen_eval_eeg.py --dataset EEG --model_path [MODELPATH]
...
if __name__ == '__main__':
    ...
    dataset_train, dataset_test = create_EEG_dataset(eeg_signals_path = config.eeg_signals_path, splits_path = config.splits_path, 
